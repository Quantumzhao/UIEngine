...
| [03 — Product MVP TUI](03-product-mvp-tui.md) | In Progress | Build a reusable XenoAtom-based TUI library that turns a Core-hosted domain graph into an interactive application. |
